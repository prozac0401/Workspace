...
Public Sub SLC_NormalizeTests()
    ...
    CheckEqual SLC_Normalize(" 홍길동 "), SLC_Normalize("홍길동"), "trim"
    CheckDifferent SLC_Normalize("홍 길동"), SLC_Normalize("홍길동"), "internal space"
    CheckEqual SLC_Normalize("ＡＢＣ１２３"), SLC_Normalize("abc123"), "fullwidth ASCII"
    ...
    CheckEqual SLC_Normalize("홍길동Ａ！～"), "#t:홍길동a!~", "mixed Unicode narrowing"
    CheckEqual SLC_Normalize(String$(4096, "Ａ")), "#t:" & String$(4096, "a"), "maximum-length narrowing"
    CheckEqual SLC_Normalize(ChrW(&HFF00) & "Ａ" & ChrW(&HFF5F)), _
