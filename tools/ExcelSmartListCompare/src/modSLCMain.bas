...
Private Sub PreviewSnapshot(ByRef completedResult As Workbook, Optional ByVal raiseTestError As Boolean = False)
    ...
    SetPhase SLC_U("B2F4 C740 0020 CCAB 0020 BAA9 B85D C758 0020 D655 C778 C6A9 0020 D30C C77C 0020 B9CC B4DC B294 0020 C911")
...
Private Sub RunSelection(ByVal replaceOnly As Boolean, ByRef completedResult As Workbook, _
    ...
    If Not combining Then
        ...
        operationCommitted = True
        mLastOutcome = SLC_U("CCAB 0020 BAA9 B85D C744 0020 B2F4 C558 C2B5 B2C8 B2E4 002E 0020 005B B2F4 C740 0020 BAA9 B85D 0020 D655 C778 005D C5D0 C11C 0020 AC12 ACFC 0020 C6D0 BCF8 0020 C704 CE58 B97C 0020 BCFC 0020 C218 0020 C788 C2B5 B2C8 B2E4 002E")
    Else
...
Public Function SLC_RulesText(ByVal fullEmail As Boolean, ByVal ignoreCase As Boolean) As String
    If fullEmail Then SLC_RulesText = SLC_U("BA54 C77C 003A 0020 C804 CCB4 0020 C8FC C18C 0020 BE44 AD50") Else SLC_RulesText = SLC_U("BA54 C77C 003A 0020 0040 0020 C55E BD80 BD84 B9CC 0020 BE44 AD50")
    If ignoreCase Then SLC_RulesText = SLC_RulesText & SLC_U("0020 002F 0020 B300 BB38 C790 00B7 C18C BB38 C790 003A 0020 AC19 AC8C 0020 BD04") Else SLC_RulesText = SLC_RulesText & SLC_U("0020 002F 0020 B300 BB38 C790 00B7 C18C BB38 C790 003A 0020 AD6C BD84 D568")
End Function

Public Function SLC_CompletionPolicyText() As String
    If mKeepFirst Then
        SLC_CompletionPolicyText = SLC_U("BE44 AD50 AC00 0020 B05D B098 BA74 0020 CCAB 0020 BAA9 B85D C744 0020 B0A8 AE41 B2C8 B2E4 002E")
    Else
        SLC_CompletionPolicyText = SLC_U("BE44 AD50 AC00 0020 B05D B098 BA74 0020 CCAB 0020 BAA9 B85D C744 0020 BE44 C6C1 B2C8 B2E4 002E")
    End If
End Function

Private Function EqualityMessage(ByVal a As CSLCList, ByVal b As CSLCList) As String
    If a.ErrorCount + b.ErrorCount > 0 Then
        EqualityMessage = SLC_U("C624 B958 0020 C140 C744 0020 BE80 0020 B098 BA38 C9C0 0020 AC12 ACFC 0020 AC1C C218 AC00 0020 AC19 C2B5 B2C8 B2E4 002E") & vbCrLf & _
...
Public Sub SLC_About()
    ...
    MsgBox SLC_U("0045 0078 0063 0065 006C 0020 BA85 B2E8 0020 BE44 AD50 0020") & SLC_ReleaseVersion() & vbCrLf & vbCrLf & _
        ...
        SLC_U("0032 002E 0020 005B B2F4 C740 0020 BAA9 B85D 0020 D655 C778 005D C5D0 C11C 0020 B2F4 C740 0020 AC12 C758 0020 C77C BD80 C640 0020 C6D0 BCF8 0020 C704 CE58 B97C 0020 D655 C778 D558 C138 C694 002E") & vbCrLf & _
