...
버전: 0.2.0 RC2 평가용 · 확인 환경: Windows 11 / 데스크톱 Excel 64비트
...
![RC2 설치 후 매크로 알림 없이 정상 시작한 Excel의 추가 기능 탭](images/11-rc2-auto-start.jpg)
...
지원 범위와 실제 시험·복구 결과는 [RC2 신뢰 위치 보고서](WINDOWS_TRUST_LOCATION_REPORT.md)와 [RC1 엔진 검증 보고서](WINDOWS_E2E_REPORT.md)를 확인하세요. Excel VBA 실행 이후 기본 실행 취소(Undo) 기록 보존은 보장하지 않습니다.
