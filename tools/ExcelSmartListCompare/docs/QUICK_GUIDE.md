...
현재 RC9에서 처리 부하·취소·설치 실행기를 보완하고 있습니다. **출시 검증은 아직 끝나지 않았습니다.** 기존 RC8의 Esc 취소 실패와 첫 설치 실패를 새 버전에서 재확인해야 합니다. [RC9 진행 결과](RC9_STABILITY_REPORT.md) · [이전 실제 시험 결과](RC8_COMPLETION_REPORT.md)
