...
현재는 RC8 소스의 한국어 문구를 다듬은 상태입니다. 새 XLAM과 설치 파일은 아직 만들지 않았습니다. 기존 RC8은 **Esc 취소 실패와 첫 설치 실패로 배포를 보류**했습니다. [이번 교정 범위](KOREAN_WORDING_REVIEW.md) · [실제 시험 결과](RC8_COMPLETION_REPORT.md)
