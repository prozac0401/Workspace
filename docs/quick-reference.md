...
<nav class="section-jumps" aria-label="상황별 판단 바로가기" markdown>
...
판단의 배경은 [10대 기본원칙](principles.md)을 참고하세요. 처음 설정한다면 [도입 순서](getting-started.md), 반복적인 대기·인수인계 문제가 있다면 [선택 운영 개선안](policies/folder-workflow.md)을 확인하세요.
