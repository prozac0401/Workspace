---
title: 자료 정리와 업무 안내
description: 파일과 메일을 어디에 둘지 정하고, 폴더에 진행 상태를 표시하고, 다음 할 일을 확인하는 방법.
hide:
  - navigation
  - toc
---
...
<span class="eyebrow">파일 · 메일 · 업무 진행 안내</span>

# 자료는 쉽게 찾고,<br>다음 할 일은 바로 알도록 {#handbook-title}

파일과 메일을 어디에 둘지,<br class="wide-break"> 일이 어디까지 됐는지 확인하는 방법을 안내합니다.
...
<span class="hero-note">회사에서 정한 저장·보관 기준에 맞춰 사용할 수 있는 제안입니다.</span>
...
<span class="eyebrow">필요한 프로그램을 골라 받으세요</span>
...
| 탐색기의 파일 목록을 정리하거나 같은 파일을 찾고 싶어요 | **[File List to Excel 1.1.0 받기](tools/file-list-to-excel/index.md)** — 파일·폴더를 우클릭해 목록이나 중복 검사 결과를 Excel로 여세요. |
| Excel에서 숨긴 행을 건너뛰어 값을 넣고 싶어요 | **[보이는 칸 붙여넣기 0.1.0 받기](tools/visible-cells-paste/index.md)** — 한 행 또는 한 열을 복사하고 대상 한 열을 선택하세요. |
| 보던 문서 위치나 웹페이지로 다시 돌아가고 싶어요 | **[업무 책갈피 0.2.3 받기](tools/bookmark/index.md)** — Ctrl+Alt+B로 남기고 목록이나 포스트잇 스티커에서 이어가세요. |

FolderState 0.1.3 RC1은 폴더 확인과 아이콘 위치 적용을 분리합니다. Excel 명단 비교 R12는 차이 결과와 담은 목록 확인의 문구·표를 간결하게 정리했습니다. 업무 책갈피 0.2.3은 포스트잇에서 메모를 편집하다 다른 창으로 이동하면 자동 저장합니다. 스티커에는 저장 버튼이 없습니다. 선택범위 내보내기 평가판은 Excel 시작 시 메뉴를 준비하고, 사용자가 누를 때만 새 통합문서를 만듭니다. File List to Excel 1.1.0은 탐색기의 파일 목록과 중복 검사 결과를 Excel로 만듭니다. 다운로드 전에 각 설치 안내에서 사용 환경과 알려진 제한을 확인하세요.

</section>

<section class="handbook-section" aria-labelledby="resume" markdown>

<span class="eyebrow">필요한 정보를 찾을 수 있나요?</span>
...
<span class="eyebrow">새 업무부터 마무리까지</span>
...
<ol class="event-flow">
<li><span class="step-number">01</span><strong>새 자료를 받으면</strong><p>쓰임을 모르면 <code>00_Inbox</code>에 잠시 두세요. 지금 하는 업무 자료는 해당 업무 폴더에 넣으세요.</p></li>
<li><span class="step-number">02</span><strong>반복 업무를 시작하면</strong><p>기본 폴더를 <code>10_Active</code>에 복사하세요. 이번 업무의 이름과 일정을 적으세요.</p></li>
<li><span class="step-number">03</span><strong>일을 진행하면</strong><p>시작하거나 마친 단계의 상태를 바꾸세요. 중요한 결정을 했다면 이유를 짧게 적으세요.</p></li>
<li><span class="step-number">04</span><strong>업무가 끝나면</strong><p>남은 일과 문제, 보관 조건을 확인하세요. 확인이 끝나면 업무 폴더 전체를 <code>80_Archive</code>로 옮기세요.</p></li>
</ol>
...
<span class="eyebrow">자주 쓰는 방법</span>
...
<span class="eyebrow">어디에서 확인하나요?</span>
...
<dl class="role-map">
<div><dt>누가 언제까지 하나요?</dt><dd>일정표와 담당자 정보</dd></div>
<div><dt>어디까지 했나요?</dt><dd>FolderState에 표시한 진행 상태</dd></div>
<div><dt>어떤 자료를 만들었나요?</dt><dd>해당 업무 폴더</dd></div>
<div><dt>무슨 대화를 했나요?</dt><dd>메일의 요청·답장</dd></div>
<div><dt>왜 그렇게 정했나요?</dt><dd>문제·결정 기록</dd></div>
</dl>
...
<span class="eyebrow">같은 불편이 반복된다면</span>
