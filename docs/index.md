...
| 보던 문서 위치나 웹페이지로 다시 돌아가고 싶어요 | **[업무 책갈피 0.2.2 받기](tools/bookmark/index.md)** — Ctrl+Alt+B로 남기고 목록이나 포스트잇 스티커에서 이어가세요. |

FolderState 0.1.3 RC1은 폴더 확인과 아이콘 위치 적용을 분리합니다. Excel 명단 비교 R12는 차이 결과와 담은 목록 확인의 문구·표를 간결하게 정리했습니다. 업무 책갈피 0.2.2는 포스트잇의 메모 영역을 한 번 눌러 바로 편집합니다. 다운로드 전에 각 설치 안내에서 사용 환경과 제한을 확인하세요.
